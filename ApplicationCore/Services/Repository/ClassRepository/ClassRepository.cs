...
namespace ApplicationCore.Services.Repository.ClassRepository
{
    public class ClassRepository<TEntity> : IClassRepository<TEntity> where TEntity : BaseEntity
    {
        protected readonly MyClassDbContext _dbContext;
        private readonly IMapper _mapper;

        public ClassRepository(MyClassDbContext dbContext, IMapper mapper)
        {
